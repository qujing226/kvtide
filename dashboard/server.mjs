...
import { createDashboardProxy } from "./server/dashboard-proxy.mjs";
...
if (import.meta.url === entryPath) {
  ...
  const runtimeProxy = createDashboardProxy({
    adminUpstream:
      process.env.KVTIDE_ADMIN_UPSTREAM ?? "http://server:8801",
  });
  createDashboardServer({ runtimeProxy }).listen(port, "0.0.0.0", () => {
