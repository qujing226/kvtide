...
type GetRuntimeResponse struct {
	...
	ModelRevision string `protobuf:"bytes,16,opt,name=model_revision,json=modelRevision,proto3" json:"model_revision,omitempty"`
	// Version of the KV tensor layout and wire encoding.
	KvLayoutVersion uint32 `protobuf:"varint,17,opt,name=kv_layout_version,json=kvLayoutVersion,proto3" json:"kv_layout_version,omitempty"`
	// Fingerprint of all settings required for KV compatibility.
	KvCompatibilityId string `protobuf:"bytes,18,opt,name=kv_compatibility_id,json=kvCompatibilityId,proto3" json:"kv_compatibility_id,omitempty"`
	// Peer-reachable address of the KV transfer service.
	TransferEndpoint string `protobuf:"bytes,19,opt,name=transfer_endpoint,json=transferEndpoint,proto3" json:"transfer_endpoint,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GetRuntimeResponse) GetModelRevision() string {
	if x != nil {
...
func (x *GetRuntimeResponse) GetKvLayoutVersion() uint32 {
	if x != nil {
		return x.KvLayoutVersion
	}
	return 0
}

func (x *GetRuntimeResponse) GetKvCompatibilityId() string {
	if x != nil {
...
func (x *GetRuntimeResponse) GetTransferEndpoint() string {
	if x != nil {
...
func (x *PushKVRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PushKVRequest) GetSourceExecutorId() string {
	if x != nil {
...
func (x *PushKVRequest) GetSourceRuntimeEpoch() uint32 {
	if x != nil {
...
func (x *PushKVRequest) GetDestinationExecutorId() string {
	if x != nil {
...
func (x *PushKVRequest) GetDestinationRuntimeEpoch() uint32 {
	if x != nil {
...
func (x *PushKVRequest) GetKvCompatibilityId() string {
	if x != nil {
		return x.KvCompatibilityId
	}
	return ""
...
func (x *PushKVRequest) GetKeyData() []byte {
	if x != nil {
		return x.KeyData
	}
	return nil
...
func (x *PushKVRequest) GetValueData() []byte {
	if x != nil {
		return x.ValueData
	}
	return nil
...
type PushKVResponse struct {
	state                   protoimpl.MessageState `protogen:"open.v1"`
	TransferId              string                 `protobuf:"bytes,1,opt,name=transfer_id,json=transferId,proto3" json:"transfer_id,omitempty"`
	DestinationExecutorId   string                 `protobuf:"bytes,2,opt,name=destination_executor_id,json=destinationExecutorId,proto3" json:"destination_executor_id,omitempty"`
	DestinationRuntimeEpoch uint32                 `protobuf:"varint,3,opt,name=destination_runtime_epoch,json=destinationRuntimeEpoch,proto3" json:"destination_runtime_epoch,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *PushKVResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PushKVResponse) GetDestinationExecutorId() string {
	if x != nil {
		return x.DestinationExecutorId
	}
	return ""
...
func (x *PushKVResponse) GetDestinationRuntimeEpoch() uint32 {
	if x != nil {
		return x.DestinationRuntimeEpoch
	}
	return 0
...
const file_kvtide_v1_executor_proto_rawDesc = "" +
	...
	"\x0ekv_cache_bytes\x18\x0f \x01(\x04R\fkvCacheBytes\x12%\n" +
