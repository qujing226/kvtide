...
func (FinishReason) Descriptor() protoreflect.EnumDescriptor {
	return file_kvtide_v1_core_proto_enumTypes[0].Descriptor()
}

func (FinishReason) Type() protoreflect.EnumType {
	return &file_kvtide_v1_core_proto_enumTypes[0]
}
...
func (FinishReason) EnumDescriptor() ([]byte, []int) {
	return file_kvtide_v1_core_proto_rawDescGZIP(), []int{0}
}
...
func (WorkPhase) Descriptor() protoreflect.EnumDescriptor {
	return file_kvtide_v1_core_proto_enumTypes[1].Descriptor()
}

func (WorkPhase) Type() protoreflect.EnumType {
	return &file_kvtide_v1_core_proto_enumTypes[1]
}
...
func (WorkPhase) EnumDescriptor() ([]byte, []int) {
	return file_kvtide_v1_core_proto_rawDescGZIP(), []int{1}
}
...
func (EventType) Descriptor() protoreflect.EnumDescriptor {
	return file_kvtide_v1_core_proto_enumTypes[2].Descriptor()
}

func (EventType) Type() protoreflect.EnumType {
	return &file_kvtide_v1_core_proto_enumTypes[2]
}
...
func (EventType) EnumDescriptor() ([]byte, []int) {
	return file_kvtide_v1_core_proto_rawDescGZIP(), []int{2}
}
...
func (x *Usage) Reset() {
	*x = Usage{}
	mi := &file_kvtide_v1_core_proto_msgTypes[0]
...
func (x *Timing) Reset() {
	*x = Timing{}
	mi := &file_kvtide_v1_core_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *BatchInfo) Reset() {
	*x = BatchInfo{}
	mi := &file_kvtide_v1_core_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_kvtide_v1_core_proto protoreflect.FileDescriptor

const file_kvtide_v1_core_proto_rawDesc = "" +
	"\n" +
	"\x14kvtide/v1/core.proto\x12\tkvtide.v1\x1a*vendor/daotl/protoc-gen-go-enums/ext.proto\x1a2vendor/daotl/protoc-gen-go-string-consts/ext.proto\"r\n" +
	"\x05Usage\x12!\n" +
	...
	"EventType_\xd0\xe4,\x01B\x96\x01\n" +
...
var (
	file_kvtide_v1_core_proto_rawDescOnce sync.Once
	file_kvtide_v1_core_proto_rawDescData []byte
)

func file_kvtide_v1_core_proto_rawDescGZIP() []byte {
	file_kvtide_v1_core_proto_rawDescOnce.Do(func() {
		file_kvtide_v1_core_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kvtide_v1_core_proto_rawDesc), len(file_kvtide_v1_core_proto_rawDesc)))
	})
	return file_kvtide_v1_core_proto_rawDescData
}

var file_kvtide_v1_core_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_kvtide_v1_core_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_kvtide_v1_core_proto_goTypes = []any{
	(FinishReason)(0), // 0: kvtide.v1.FinishReason
	(WorkPhase)(0),    // 1: kvtide.v1.WorkPhase
	(EventType)(0),    // 2: kvtide.v1.EventType
	(*Usage)(nil),     // 3: kvtide.v1.Usage
	(*Timing)(nil),    // 4: kvtide.v1.Timing
	(*BatchInfo)(nil), // 5: kvtide.v1.BatchInfo
}
var file_kvtide_v1_core_proto_depIdxs = []int32{
...
func init() { file_kvtide_v1_core_proto_init() }
func file_kvtide_v1_core_proto_init() {
	if File_kvtide_v1_core_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kvtide_v1_core_proto_rawDesc), len(file_kvtide_v1_core_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_kvtide_v1_core_proto_goTypes,
		DependencyIndexes: file_kvtide_v1_core_proto_depIdxs,
		EnumInfos:         file_kvtide_v1_core_proto_enumTypes,
		MessageInfos:      file_kvtide_v1_core_proto_msgTypes,
	}.Build()
	File_kvtide_v1_core_proto = out.File
	file_kvtide_v1_core_proto_goTypes = nil
	file_kvtide_v1_core_proto_depIdxs = nil
}
